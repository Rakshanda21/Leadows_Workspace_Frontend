...
import { DisplayNameForPyramidUserRole, LeadowsUserRoles } from "../../utils/UserRoles";
                                        ...
                                        {state.allUsersDetails.length > 0 &&
                                            state.allUsersDetails.map((row, index) => (
                                                <StyledTableRow key={index}>
                                                    ...
                                                    <StyledTableCell className="tableContentFont">{row.designation}</StyledTableCell>
                                                    {row.status === "ACTIVE" ? (
                                                        <StyledTableCell className="tableContentFont">
                                                            {state.userDetails?.userRole === LeadowsUserRoles.ORG_OWNER
                                                                ? row.userRole !== LeadowsUserRoles.ORG_OWNER && (
                                                                      <IconButton onClick={() => handleOnClickDelete(row)}>
                                                                          <ToggleOnIcon
                                                                              fontSize="large"
                                                                              sx={{
                                                                                  color: theme.typography.primary.black,
