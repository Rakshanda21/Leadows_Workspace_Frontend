...
import { Grid, Avatar, Paper, Table, TableBody, TableCell, TableFooter, TableHead, TablePagination, TableRow, useTheme } from "@mui/material";
                                                    ...
                                                    <StyledTableCell className="tableContentFont">
                                                        <Avatar
                                                            sx={{
                                                                ...
                                                                backgroundColor: UserProfileColors[row?.role[0].toUpperCase()],

                                                                border: `1px solid ${theme.palette.primary.borderColor}`,
                                                            }}
                                                        >
                                                            {row.role[0].toUpperCase()}
                                                        </Avatar>
                                                    </StyledTableCell>
