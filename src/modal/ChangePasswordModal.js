import { Close, VisibilityOffOutlined, VisibilityOffRounded } from "@mui/icons-material";
import {
  Dialog,
  DialogContent,
  FormControl,
...
export default function ChangePasswordModal({ open, handleCloseChangePassword }) {
    ...
    return (
        ...
        >
            <DialogContent>
                <Grid alignItems="center" display={"flex"} justifyContent="space-between"></Grid>
                ...
                <Grid alignItems={"center"} display={"flex"} flexDirection={"column"} gap={4} mt={4}>
                            ...
                            endAdornment={
                                <InputAdornment position="end">
                                    <IconButton
                                        ...
                                        edge="end"
                                    >
                                        {showNewPassword ? <VisibilityOffOutlined /> : <VisibilityOffRounded />}
                                    </IconButton>
                                </InputAdornment>
                            }
                        />
                            ...
                            endAdornment={
                                <InputAdornment position="end">
                                    <IconButton
                                        ...
                                        edge="end"
                                    >
                                        {showConfirmPassword ? <VisibilityOffOutlined /> : <VisibilityOffRounded />}
                                    </IconButton>
                                </InputAdornment>
                            }
                        />
